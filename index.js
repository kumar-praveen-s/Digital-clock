...
function setTime(){
    ...
    if(h1==hh){
        document.getElementById("pic-container").style.backgroundImage="url(morning.png)";
        document.getElementById("text").innerHTML="Wake up";
    }
    if(h2==hh){
        document.getElementById("pic-container").style.backgroundImage="url(noon.png)";
        document.getElementById("text").innerHTML="Let's Have some Lunch";
    }
    if(h3==hh){
        document.getElementById("pic-container").style.backgroundImage="url(night.png)";
